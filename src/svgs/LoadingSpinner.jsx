...
function LoadingSpinner({
  ...
  return (
    <svg
      ...
      {...rest}
    >
      <rect width={6} height={14} x={1} y={4} fill={fillColor}>
        <animate
      ...
      <rect width={6} height={14} x={9} y={4} fill="#4f66b1" opacity={0.4}>
        <animate
          fill="freeze"
          attributeName="y"
      ...
      <rect width={6} height={14} x={17} y={4} fill="#4f66b1" opacity={0.3}>
        <animate
